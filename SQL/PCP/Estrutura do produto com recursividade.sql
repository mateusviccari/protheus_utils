...
cross apply (
	...
	from TIMIGPLUS.estoque.estrutura_com_recursividade(R.B1_COD, R.B1_QB, 0, 1)
) as estr
...
begin
	...
	from DADOSADV.dbo.SG1010 as G1 with(nolock)
	inner join DADOSADV.dbo.SB1010 as B1R with(nolock) on B1R.D_E_L_E_T_ = '' and B1R.B1_FILIAL = '00' and B1R.B1_COD = G1.G1_COD
	cross apply (select case when B1R.B1_QB = 0 then 1 else B1R.B1_QB end as qtd_base) as produto_pai
	cross apply (
		select case when exists
			(select 1 from DADOSADV.dbo.SG1010 as G1I with(nolock)
	...
	where G1.D_E_L_E_T_ = '' and G1_FILIAL = '00'
	and (select count(*) from DADOSADV.dbo.SG1010 as G1I with(nolock) where G1I.D_E_L_E_T_ = '' and G1I.G1_FILIAL = '00' and G1I.G1_COD = G1.G1_COMP) > 0
	and G1_COD = @codigo_produto;
